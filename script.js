function akan(){
    ar year = parseFloat(document.getElementById("year").value)
    console.log(year);
    ar month = parseFloat(document.getElementById("month").value);
     //console.log(month); 
      ...
      //console.log(day);
       var century = parseFloat(year/100) +1;
        //console.log(century);
         ...
         ar gender = document.getElementById("gender").value;
          //console.log(gender);
           var male= ["Kwasi", "Kwadwo", "Kwabena", "Kwaku", "Yaw", "Kofi", "Kwame"]; 
           var female = ["Akosua","Adwoa","Abenaa","Akua","Yaa", "Afua","Ama"]; 
           if(year < 0) { alert("Please enter a valid year");
            }
            else {
                   ...
                   if(birthday===4 && gender==="male")
                    ...
                    document.getElementById("display").innerHTML = male [4];
                     ...
                     if(birthday===5 && gender==="male")
                      {
                       document.getElementById("display").innefunction akan(){
ar year = parseFloat(document.getElementById("year").value)
console.log(year);
ar month = parseFloat(document.getElementById("month").value);
//console.log(month); 
